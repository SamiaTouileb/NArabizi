    ...
    def train(self):
        ...
        for epoch in range(self.history.start_epoch, self.history.start_epoch + self.epochs):
            ...
            if dev_score > self.history.best_dev_score:
                ...
                self.history.update_best_dev_score(dev_score,
                                                   epoch, epoch_duration, dev_preds)

            # Update and show history
            self.history.update_hist(epoch, loss, dev_score, epoch_duration)
...
class History:
    ...
    def update_best_dev_score(self, dev_score, epoch, epoch_duration, dev_preds):
        ...
        params = {**self.trainer_params,
                  **{"epoch": epoch, "dev_score": dev_score,
    ...
    def update_hist(self, epoch, loss, dev_score, epoch_duration):
    ...
    def show_hist(self):
        ...
        for epoch in self.epoch_list:
            if epoch == self.best_dev_epoch:
                ...
                bold_code = ("", "")
            print(bold_code[0] + "{:<20}{:<20.3f}{:<20.3f}".format(
